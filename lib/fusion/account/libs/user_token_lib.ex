defmodule Fusion.Account.UserTokenLib do
  @moduledoc """
  Library of UserToken related functions.
  """
  alias Fusion.Repo
  alias Fusion.Account.{UserToken, UserTokenQueries}
  ...
  def delete_user_token(%UserToken{} = user_token) do
    Fusion.invalidate_cache(:user_token_identifier_cache, user_token.identifier_code)
  ...
  @spec delete_user_tokens(Fusion.user_id()) :: :ok
