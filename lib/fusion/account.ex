defmodule Fusion.Account do
  alias Fusion.Account.{User, UserLib, UserQueries}
  ...
  @doc false
  @spec user_query(Fusion.query_args()) :: Ecto.Query.t()
  ...
  @spec get_user!(Fusion.user_id(), Fusion.query_args()) :: User.t()
  defdelegate get_user!(user_id, query_args \\ []), to: UserLib

  @doc section: :user
  @spec get_user(Fusion.user_id()) :: User.t() | nil
  @spec get_user(Fusion.user_id(), Fusion.query_args()) :: User.t() | nil
  defdelegate get_user(user_id, query_args \\ []), to: UserLib
  ...
  # UserTokens
  alias Fusion.Account.{UserToken, UserTokenLib, UserTokenQueries}

  @doc false
  @spec user_token_query(Fusion.query_args()) :: Ecto.Query.t()
  defdelegate user_token_query(args), to: UserTokenQueries

  @doc section: :user_token
  @spec list_user_tokens(Fusion.query_args()) :: [UserToken.t()]
  defdelegate list_user_tokens(args), to: UserTokenLib

  @doc section: :user_token
  @spec get_user_token!(UserToken.id()) :: UserToken.t()
  @spec get_user_token!(UserToken.id(), Fusion.query_args()) :: UserToken.t()
  defdelegate get_user_token!(user_token_id, query_args \\ []), to: UserTokenLib

  @doc section: :user_token
  @spec get_user_token(UserToken.id()) :: UserToken.t() | nil
  @spec get_user_token(UserToken.id(), Fusion.query_args()) :: UserToken.t() | nil
  defdelegate get_user_token(user_token_id, query_args \\ []), to: UserTokenLib
  ...
  @doc section: :user_token
  @spec create_user_token(Fusion.user_id(), String.t(), String.t(), String.t()) ::
