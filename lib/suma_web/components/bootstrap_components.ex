defmodule SumaWeb.BootstrapComponents do
  @moduledoc false
  ...
  @doc """
  <SumaWeb.BootstrapComponents.dropdown items={@items} />
  """
  ...
  @doc """
  <SumaWeb.BootstrapComponents.dropdown unit={@unit} limit={@limit} display_mode={@display_mode} />
  ...
  @doc """
  <SumaWeb.BootstrapComponents.card>
    CONTENT
  </SumaWeb.BootstrapComponents.card>
  """
  slot :inner_block, required: true
  ...
  <SumaWeb.BootstrapComponents.pill>
    CONTENT
  </SumaWeb.BootstrapComponents.pill>
  """
  slot :inner_block, required: true
