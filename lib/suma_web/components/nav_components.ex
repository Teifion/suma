defmodule SumaWeb.NavComponents do
  @moduledoc false
  ...
  @doc """
  <SumaWeb.NavComponents.top_nav_item active={active} route={route} icon={icon} />
  """
  ...
  @doc """
  <SumaWeb.NavComponents.top_navbar current_user={@current_user} active={"string"} />
  """
    ...
    <nav class="navbar navbar-expand-lg m-0 p-0" id="top-nav">
      ...
      <div class="container-fluid">
        ...
        <div class="d-flex align-items-center">
          <%= if @current_user do %>
            <SumaWeb.NavComponents.recents_dropdown current_user={@current_user} />
            <SumaWeb.NavComponents.account_dropdown current_user={@current_user} />
          <% else %>
  ...
  def recents_dropdown(assigns) do
    ...
    #   |> Suma.Account.RecentlyUsedCache.get_recently()
    #   |> Enum.take(15)
