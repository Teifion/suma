defmodule SumaWeb.UserComponents do
  @moduledoc false
  use SumaWeb, :component
  import SumaWeb.{NavComponents}

  @doc """
  <SumaWeb.UserComponents.filter_bar active="active" />

  <SumaWeb.UserComponents.filter_bar active="active">
    Right side content here
  </SumaWeb.UserComponents.filter_bar>
  """
  ...
  @doc """
  <SumaWeb.UserComponents.status_icon user={user} />
  """
  ...
  @doc """
  <SumaWeb.UserComponents.recents_dropdown current_user={@current_user} />
  """
  ...
  @doc """
  <SumaWeb.UserComponents.account_dropdown current_user={@current_user} />
  """
  attr :current_user, :map, required: true
