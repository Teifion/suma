defmodule FusionWeb.BootstrapComponents do
  @moduledoc false
  ...
  @doc """
  <FusionWeb.BootstrapComponents.dropdown items={@items} />
  """
  ...
  @doc """
  <FusionWeb.BootstrapComponents.dropdown unit={@unit} limit={@limit} display_mode={@display_mode} />
  ...
  @doc """
  <FusionWeb.BootstrapComponents.card>
    CONTENT
  </FusionWeb.BootstrapComponents.card>
  """
  slot :inner_block, required: true
  ...
  <FusionWeb.BootstrapComponents.pill>
    CONTENT
  </FusionWeb.BootstrapComponents.pill>
  """
  slot :inner_block, required: true
