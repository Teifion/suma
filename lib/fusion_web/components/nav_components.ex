defmodule FusionWeb.NavComponents do
  @moduledoc false
  ...
  @doc """
  <FusionWeb.NavComponents.top_nav_item active={active} route={route} icon={icon} />
  """
  ...
  @doc """
  <FusionWeb.NavComponents.top_navbar current_user={@current_user} active={"string"} />
  """
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <a class="navbar-brand mt-2 mt-lg-0" href="/">
            <i
              class={"fa-fw #{Application.get_env(:fusion,Fusionty)[:site_icon]}"}
        ...
        <div class="d-flex align-items-center">
          <%= if @current_user do %>
            <FusionWeb.NavComponents.recents_dropdown current_user={@current_user} />
            <FusionWeb.NavComponents.account_dropdown current_user={@current_user} />
          <% else %>
  ...
  def recents_dropdown(assigns) do
    ...
    #   |> Fusion.Account.RecentlyUsedCache.get_recently()
    #   |> Enum.take(15)
