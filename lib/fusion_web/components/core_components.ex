defmodule FusionWeb.CoreComponents do
  @moduledoc """
  ...
  @doc """
  <.modal id="invite-link-modal" show={assigns[:show_link_modal]}>
    <:title>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FusionWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FusionWeb.Gettext, "errors", msg, opts)
    end
  end
