defmodule FusionWeb.ModelComponents do
  ...
  @doc """
  <FusionWeb.ModelComponents.status_icon user={user} />
  """
  ...
  @doc """
  <FusionWeb.ModelComponents.recents_dropdown current_user={@current_user} />
  """
  attr :current_user, :map, required: true
  ...
  @doc """
  <FusionWeb.ModelComponents.account_dropdown current_user={@current_user} />
  """
  attr :current_user, :map, required: true
