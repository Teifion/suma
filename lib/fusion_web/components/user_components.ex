defmodule FusionWeb.UserComponents do
  @moduledoc false
  use FusionWeb, :component
  import FusionWeb.{NavComponents}

  @doc """
  <FusionWeb.UserComponents.filter_bar active="active" />

  <FusionWeb.UserComponents.filter_bar active="active">
    Right side content here
  </FusionWeb.UserComponents.filter_bar>
  """
  ...
  @doc """
  <FusionWeb.UserComponents.status_icon user={user} />
  """
  ...
  @doc """
  <FusionWeb.UserComponents.recents_dropdown current_user={@current_user} />
  """
  ...
  @doc """
  <FusionWeb.UserComponents.account_dropdown current_user={@current_user} />
  """
  attr :current_user, :map, required: true
