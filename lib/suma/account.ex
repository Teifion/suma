defmodule Suma.Account do
  alias Suma.Account.{User, UserLib, UserQueries}
  ...
  @doc false
  @spec user_query(Suma.query_args()) :: Ecto.Query.t()
  ...
  @doc section: :user
  @spec get_user(Suma.user_id()) :: User.t() | nil
  ...
  @doc section: :user_token
  @spec create_user_token(Suma.user_id(), String.t(), String.t(), String.t()) ::
