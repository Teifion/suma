defmodule Suma.Account.UserTokenLib do
  @moduledoc """
  Library of UserToken related functions.
  """
  alias Suma.Repo
  alias Suma.Account.{UserToken, UserTokenQueries}
  ...
  def delete_user_token(%UserToken{} = user_token) do
    Suma.invalidate_cache(:user_token_identifier_cache, user_token.identifier_code)
  ...
  @spec delete_user_tokens(Suma.user_id()) :: :ok
